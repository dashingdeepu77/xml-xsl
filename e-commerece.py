...
xml = etree.parse("Labworks\Lab Ex5-XSL\ecommerce.xml")
xsl = etree.parse("Labworks\Lab Ex5-XSL\ecommerce.xsl")
xsd = etree.parse("Labworks\Lab Ex5-XSL\ecommerce.xsd") 
